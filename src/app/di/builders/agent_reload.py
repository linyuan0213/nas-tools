...
def rebuild_agent_rag(context: AppContext) -> dict[str, bool]:
    ...
    tool_context = ToolContext(
        ...
        site_service=context.site_service,
        brush_service=context.brush_service,
        media_library_service=context.media_library_service,
        transfer_history_service=context.transfer_history_service,
        user_rss_service=context.user_rss_service,
        knowledge_ingestor=context.knowledge_ingestor,
        indexer_service=context.indexer_service,
        torrent_remover_service=context.torrent_remover_service,
        storage_backend_service=context.storage_backend_service,
        words_service=context.words_service,
        plugin_framework_service=context.plugin_framework_service,
        message_client_service=context.message_client_service,
        media_server_config_service=context.media_server_config_service,
        indexer_config_service=context.indexer_config_service,
        system_config_service=context.system_config_service,
        media_config_service=context.media_config_service,
