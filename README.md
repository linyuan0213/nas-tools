...
##### 功能优化
- 新增RSS自动生成插件
- 自动备份插件支持 WebDAV 和 Samba
- Emby 媒体库同步删除插件支持原生webhook，不再依赖Emby插件
- 企业微信可信任IP更新插件支持二维码扫码登录
- 企业微信可信任IP更新插件支持多个应用更新ip
- 支持唐门、雨、财神、星陨阁、ptzone、PTFans等站点
- 支持带有长亭雷池人机验证的站点签到

##### 问题修复
- OpenAI api兼容gemini api
- 修复我堡和自由农场的副标题和标签显示问题
